...
### 3.8 T1 实测(2026-06-04 15:43,+4h41min)— **重大反转:arena 55 不是活跃累积者**

> ⚠ T1 数据揭示了一个关键事实:**arena 55 在 T0 → T1 期间几乎没涨**(2048 → 2047 MB),但 RSS 涨了 789 MB。
>
> 这意味着 §3.5 / §3.6 / §3.7 中所有"arena 55 = 单 worker 累积 leak"的推论**只对 T0 之前的历史成立**;**T0 之后的 168 MB/h 活跃 leak 在别的地方**。
>
