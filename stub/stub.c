 ...
 *
 * antirev_shim.so combines the exe-identity interceptors (readlink,
 * realpath, getauxval …) and the dlopen interceptor into a single
 * LD_PRELOAD-able DSO.  The aarch64-only extend shim (ANTI_LoadProcess
