                    ...
                    int flags, mode_t mode, bool safe)
{
    ...
    /*
     * Per-guest decrypt gate: an unauthorized guest reading a protected file
     * gets keyless ciphertext (fd >= 0) or is denied (-1, errno set); an
     * authorized guest / unprotected file returns -2 (do the normal open).
     */
                      ...
                      abi_ulong guest_size)
{
    ...
    if (fd > -2) {
        ...
        /* Per-guest decrypt gate (see do_guest_openat). */
