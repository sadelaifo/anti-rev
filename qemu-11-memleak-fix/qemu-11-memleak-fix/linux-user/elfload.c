...
int load_elf_binary(struct linux_binprm *bprm, struct image_info *info)
{
    ...
    /*
     * Decide this guest's decrypt authorization from its program binary's
     * vendor signature (via /dev/vcachefs).  Governs whether the guest's later
     * reads of protected files see plaintext (mount) or keyless ciphertext.
     * No-op when the gate is inactive.
     */
