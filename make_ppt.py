...
content_slide(prs, "dlopen_shim: Intercepting Dynamic Loading", [
    ...
    "  Stub pre-fetches all libs, sets __r_FM=\"libfoo.so=5,libbar.so=6\"",
    "  dlopen_shim maps basename -> /proc/self/fd/N",
    "",
    "Lazy mode (large apps, daemon):",
    "  Stub keeps daemon socket open (__r_LS=fd)",
    "  On dlopen(\"libfoo.so\"):",
    ...
    "",
    "__r_NP=1 escape hatch: skip per-dep preload,",
...
two_col_slide(prs,
    ...
    [
        ...
        "",
        "Implicit inter-lib deps: __r_NP",
